    ...
    <div className="bg-white">
      ...
      <section className="bg-pink-600 h-80 flex items-center justify-center">
        <div className="text-center p-4">
          ...
          <p className="text-xl text-white max-w-2xl">
            Un espacio seguro y estimulante para el desarrollo de los más jóvenes
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4 max-w-6xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-semibold text-center mb-8 text-blue-800">
          Bienvenidos a nuestra Área Secundaria
        </h2>
        <p className="text-lg text-gray-700 mb-6 text-center max-w-3xl mx-auto">
          En Instituto Piaget, creamos un entorno cálido y acogedor donde los jóvenes de comienzan a descubrir el mundo a través del juego, la música y la interacción social.
        </p>
